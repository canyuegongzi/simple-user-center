...
var RedisCacheService = /** @class */ (function () {
    function RedisCacheService(redisService) {
        ...
        this.getClient().then(function (r) { });
    }
    ...
    // 设置值的方法
    RedisCacheService.prototype.set = function (key, value, seconds) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        _a.label = 2;
                    case 2:
                        if (!!seconds) return [3 /*break*/, 4];
                        return [4 /*yield*/, this.client.set(key, value)];
                    case 3:
                        _a.sent();
                        return [3 /*break*/, 6];
                    case 4: return [4 /*yield*/, this.client.set(key, value, 'EX', seconds)];
                    case 5:
                        _a.sent();
                        _a.label = 6;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        _a.label = 2;
                    case 2: return [4 /*yield*/, this.client.get(key)];
                    case 3:
                        data = _a.sent();
                        if (!data) {
                            return [2 /*return*/];
...
//# sourceMappingURL=redisCache.service.js.map