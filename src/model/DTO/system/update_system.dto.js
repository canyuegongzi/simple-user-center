...
var UpdateSystemDto = /** @class */ (function () {
    function UpdateSystemDto() {
    }
    __decorate([
    ...
    ], UpdateSystemDto.prototype, "name");
    __decorate([
    ...
    ], UpdateSystemDto.prototype, "value");
    __decorate([
        class_validator_1.IsNotEmpty({ message: '系统值不能为空', context: { errorCode: api_error_code_enum_1.ApiErrorCode.USER_NAME_STRING } })
    ], UpdateSystemDto.prototype, "id");
    return UpdateSystemDto;
}());
exports.UpdateSystemDto = UpdateSystemDto;
//# sourceMappingURL=update_system.dto.js.map